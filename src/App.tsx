...
import { 
  Sparkles, Heart, Star, Play, ArrowRight, Compass, 
  MapPin, HelpCircle 
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0b0d12] text-slate-100 font-sans relative selection:bg-amber-500 selection:text-slate-950">
      ...
      <header className="relative z-30 max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => setActiveTab('explore')}>
          <div className="w-9 h-9 rounded-full bg-amber-400 text-slate-950 flex items-center justify-center font-extrabold shadow-[0_0_20px_rgba(251,191,36,0.5)]">
            <Sparkles className="w-5 h-5 fill-slate-950" />
          </div>
          <div>
            <span className="text-2xl font-serif tracking-tight text-white font-semibold">gaido</span>
            <span className="text-[9px] uppercase tracking-[0.25em] text-slate-400 block -mt-1 font-mono">
              YOUR TRAVEL GUIDER
            </span>
          </div>
        </div>
